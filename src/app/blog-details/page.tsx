            ...
            <div className="w-full px-4 lg:w-8/12">
              <div>
                <h2 className="mb-8 text-3xl font-bold leading-tight text-black dark:text-white sm:text-4xl sm:leading-tight">
                  An extraordinary site that can help manage your business
                </h2>
                ...
                <div>
                  <p className="mb-10 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                    ...
                    platform empowers businesses to grow and succeed in the
                    digital age.
                  </p>
                  ...
                  <p className="mb-8 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                    With intuitive tools and intelligent automation, helps you
                    optimize workflow, manage resources efficiently, and stay
                    ahead of the competition. Whether you’re a startup or an
                    established enterprise, our scalable solutions adapt to your
                    business needs, ensuring continuous growth and innovation.
                    <strong className="text-primary dark:text-white">
                      Buiten Technology
                    </strong>
                    Experience the future of business management with Buiten
                    Technology—where innovation meets efficiency.
                  </p>
                  <p className="mb-10 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                  ...
                  <h3 className="font-xl mb-10 font-bold leading-tight text-black dark:text-white sm:text-2xl sm:leading-tight lg:text-xl lg:leading-tight xl:text-2xl xl:leading-tight">
                    Digital marketplace for your bunsiness.
                  </h3>
                  <p className="mb-10 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                    Experience the power of Buiten Technology, the ultimate
                    platform designed to streamline your business operations
                    efficiently and effectively.
                  </p>
                  <ul className="mb-10 list-inside list-disc text-body-color">
                    <li className="mb-2 text-base font-medium text-body-color sm:text-lg lg:text-base xl:text-lg">
                      Seamless Management – Simplify business operations with an
                      integrated system.
                    </li>
                    <li className="mb-2 text-base font-medium text-body-color sm:text-lg lg:text-base xl:text-lg">
                      Maximum Efficiency – Optimize every aspect of your
                      business with advanced features.
                    </li>
                    <li className="mb-2 text-base font-medium text-body-color sm:text-lg lg:text-base xl:text-lg">
                      Top-Notch Security – Keep your business data safe with
                  ...
                  <div className="relative z-10 mb-10 overflow-hidden rounded-md bg-primary bg-opacity-10 p-8 md:p-9 lg:p-8 xl:p-9">
                    <p className="text-center text-base font-medium italic text-body-color">
                      With Buiten Technology, you gain access to innovative
                      tools that enhance productivity, improve collaboration,
                      and drive growth. Whether you’re managing sales,
                      inventory, or customer relations, our platform ensures
                  ...
                  <p className="mb-10 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                    From startups to enterprises, Buiten Technology adapts to
                    your business needs, offering flexible solutions that grow
                    with you. Unlock the potential of your business today and
