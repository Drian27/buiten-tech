        ...
        <div className="container">
          <div className="relative w-full flex items-center justify-between">
                            ...
                            >
                              {menuItem.submenu.map((submenuItem, index) => (
                                <Link
                                  ...
                                  key={index}
                                  className="block rounded py-2.5 text-sm text-dark hover:text-primary dark:text-white/70 dark:hover:text-white lg:px-3 mb-1"
                                >
                                  {submenuItem.title}
                                </Link>
                              ))}
            ...
            <div className="flex items-center pr-16 lg:pr-0">
                <div>
                    <button className="rounded bg-primary px-7 py-3 text-base font-medium text-white shadow-submit duration-300 hover:bg-primary/90 dark:shadow-submit-dark">
                      Contact Us
                    </button>
                </div>
                <div>
