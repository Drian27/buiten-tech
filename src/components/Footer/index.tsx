        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-7 gap-8 px-4">
          ...
          <div className="lg:col-span-2 max-w-[500px]">
            ...
            <div className="flex space-x-4 mt-6">
              ...
              <a href="/" aria-label="Twitter" target="_blank" rel="noopener noreferrer" className="text-body-color hover:text-primary dark:text-body-color-dark dark:hover:text-primary">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
              ...
              <a href="/" aria-label="YouTube" target="_blank" rel="noopener noreferrer" className="text-body-color hover:text-primary dark:text-body-color-dark dark:hover:text-primary">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
              ...
              <a href="/" aria-label="LinkedIn" target="_blank" rel="noopener noreferrer" className="text-body-color hover:text-primary dark:text-body-color-dark dark:hover:text-primary">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
